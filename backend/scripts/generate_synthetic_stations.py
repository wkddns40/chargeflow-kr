...
REGIONS = (
    Region(
        ...
        0.50,
        (
            Area("Seoul Gangnam", "Seoul Gangnam-gu Teheran-ro", 127.034, 127.062, 37.499, 37.524),
            Area("Seoul Seocho", "Seoul Seocho-gu Gangnam-daero", 127.002, 127.026, 37.478, 37.500),
            Area("Seoul Songpa", "Seoul Songpa-gu Olympic-ro", 127.095, 127.120, 37.500, 37.520),
            Area("Seoul Mapo", "Seoul Mapo-gu World Cup buk-ro", 126.900, 126.925, 37.548, 37.568),
            Area("Seoul Seongdong", "Seoul Seongdong-gu Wangsimni-ro", 127.030, 127.055, 37.545, 37.565),
            Area("Seoul Yongsan", "Seoul Yongsan-gu Hangang-daero", 126.968, 126.995, 37.522, 37.542),
            Area("Seoul Jongno", "Seoul Jongno-gu Sejong-daero", 126.970, 126.995, 37.568, 37.588),
            Area("Suwon", "Gyeonggi-do Suwon-si Paldal-gu", 127.015, 127.045, 37.255, 37.285),
            Area("Seongnam", "Gyeonggi-do Seongnam-si Bundang-gu", 127.125, 127.158, 37.405, 37.435),
            Area("Goyang", "Gyeonggi-do Goyang-si Ilsandong-gu", 126.775, 126.815, 37.638, 37.668),
            Area("Yongin", "Gyeonggi-do Yongin-si Suji-gu", 127.115, 127.150, 37.230, 37.260),
            Area("Bucheon", "Gyeonggi-do Bucheon-si", 126.755, 126.782, 37.488, 37.512),
            Area("Ansan", "Gyeonggi-do Ansan-si Danwon-gu", 126.820, 126.852, 37.305, 37.335),
            Area("Anyang", "Gyeonggi-do Anyang-si Dongan-gu", 126.948, 126.970, 37.385, 37.405),
        ),
    ),
    Region(
        "other_metro",
        ...
        (
            ...
            Area("Busan Station", "Busan Dong-gu Jungang-daero", 129.040, 129.075, 35.105, 35.130),
            ...
            Area("Daejeon Central", "Daejeon Dong-gu Jungang-ro", 127.420, 127.445, 36.340, 36.360),
    ...
    Region(
        ...
        0.15,
        (
            Area("Jeju City", "Jeju-si Airport-ro", 126.498, 126.548, 33.485, 33.510),
            Area("Seogwipo", "Seogwipo-si Jungang-ro", 126.555, 126.582, 33.245, 33.265),
