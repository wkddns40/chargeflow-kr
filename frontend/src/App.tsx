...
import { isRoutePlannerFlagEnabled } from './lib/routePlanner';
...
const routePlannerEnabled = isRoutePlannerFlagEnabled(import.meta.env.VITE_ENABLE_ROUTE_PLANNER);
...
function StationMap() {
  ...
  return <MapShell stations={stations} assistantSearchEnabled={llmSearchEnabled} routePlannerEnabled={routePlannerEnabled} />;
}
